...
export default function ContactPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        window.location.href = `mailto:solutions@cyberforenx.com?subject=${subject}&body=${body}`;
    };
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-white text-zinc-950 py-5 rounded-2xl text-xs font-black uppercase tracking-[0.3em] flex items-center justify-center gap-4 hover:bg-zinc-100 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_15px_30px_rgba(255,255,255,0.1)]"
                            >
