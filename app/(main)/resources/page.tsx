...
export const metadata = constructMetadata({
  ...
  description: "Explore the latest in cybersecurity, forensics, and enterprise technology. Whitepapers, case studies, and industry intelligence from Cyberforenx experts.",
