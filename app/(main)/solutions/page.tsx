...
export const metadata = constructMetadata({
  ...
  description: "Specialized technology solutions for Digital Commerce, Government, Healthcare, and Finance. Cyberforenx delivers secure, scalable innovation across sectors.",
