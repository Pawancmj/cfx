...
import {
    ...
    ArrowRight, Code,
    Rocket, Sparkles, X, Send, XCircle, Globe
} from "lucide-react";
import { cn } from "../../../lib/utils";

const benefits = [
    { title: "MNC Culture", desc: "Work in a high-performance environment with global delivery standards.", icon: Users },
    { title: "Direct Mentorship", desc: "Learn directly from veterans in forensics and engineering.", icon: GraduationCap },
    { title: "Global Impact", desc: "Contribute to projects securing mission-critical enterprise assets.", icon: Globe },
    { title: "Innovative Tech", desc: "Stay ahead with the latest in Next.js, AI, and Cloud Security.", icon: Sparkles },
];

const hiringSteps = [
    { title: "Apply", desc: "Submit your profile and resume for our expert review.", icon: Send },
    { title: "Assessment", desc: "Showcase your skills through a tailored technical challenge.", icon: Code },
    { title: "Interview", desc: "Connect with our leadership to discuss your vision and fit.", icon: Users },
    { title: "Onboarding", desc: "Welcome to the force. Let's build something extraordinary.", icon: Rocket },
];
            ...
            <div className="container mx-auto px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
                    {benefits.map((item, i) => (
                        <motion.div
                            ...
                            className="p-8 rounded-[2rem] glass-card text-center transition-all duration-500 border-white/5 hover:bg-white/10 hover:-translate-y-2 group"
                        >
                ...
                <div className="mb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {loadingVacancies ? (
                            <div className="col-span-full py-20 text-center glass-card border-white/5 bg-white/5 rounded-[2rem]">
                                <div className="w-12 h-12 border-4 border-primary border-t-transparent rounded-full animate-spin mx-auto mb-6"></div>
                                <p className="text-zinc-500 font-bold uppercase tracking-widest text-xs">Synchronizing with Global Database...</p>
                            </div>
                        ) : vacancies.length === 0 ? (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="col-span-full py-20 text-center glass-card border-white/5 bg-white/5 rounded-[2rem]"
                            >
                            ...
                            vacancies.map((role, index) => (
                                ...
                                >
                                            ...
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-3 mt-1">
                                                        ...
                                                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-primary/60">{role.location}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <button
                                        ...
                                        className="relative z-10 inline-flex items-center gap-4 text-primary font-black text-xs tracking-[0.3em] uppercase group/btn mt-auto"
                                    >
                        ...
                        {hiringSteps.map((step, i) => (
                            <div key={i} className="relative group">
                                {i < hiringSteps.length - 1 && (
                                    <div className="hidden lg:block absolute top-1/2 left-[calc(100%-1rem)] w-8 h-px bg-white/10 z-0"></div>
                                )}
                                <div className="p-8 rounded-[2rem] glass-card border-white/5 bg-white/5 text-center transition-all group-hover:border-primary/30 relative z-10">
